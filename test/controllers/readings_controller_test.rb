...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { date: @reading.date, diastolic: @reading.diastolic, heart_rate: @reading.heart_rate, systolic: @reading.systolic, user_id: @reading.user_id }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { date: @reading.date, diastolic: @reading.diastolic, heart_rate: @reading.heart_rate, systolic: @reading.systolic, user_id: @reading.user_id }
    assert_redirected_to reading_path(assigns(:reading))
  end
